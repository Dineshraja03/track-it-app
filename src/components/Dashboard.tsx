  ...
  return (
    <div className="p-4 pb-24 space-y-6 animate-fade-in">
      ...
      <div className="text-center pt-4">
        ...
        <p className="text-gray-600 dark:text-gray-300 mt-1">Manage your expenses smartly</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <Card className="shadow-sm border-blue-100 dark:border-gray-700">
      ...
      <Card className="shadow-sm border-blue-100 dark:border-gray-700">
        ...
        <CardContent className="p-4 pt-0">
          <div className="grid grid-cols-2 gap-3">
            ...
            <button className="p-3 bg-red-50 dark:bg-red-900/20 rounded-lg text-center hover:bg-red-100 dark:hover:bg-red-900/30 transition-colors">
              <span className="text-2xl block mb-1">💸</span>
